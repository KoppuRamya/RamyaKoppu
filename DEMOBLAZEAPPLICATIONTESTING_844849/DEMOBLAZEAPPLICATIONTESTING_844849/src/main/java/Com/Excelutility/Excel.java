...
public class Excel 
{
	public  String excel_username(int a) throws IOException {
		  ...
		  FileInputStream fil = new FileInputStream(new File("C:\\Users\\Ramya\\Desktop\\DEMOBLAZEAPPLICATIONTESTING_844849\\DEMOBLAZEAPPLICATIONTESTING_844849\\src\\test\\resources\\Testdata\\Book1.xlsx"));
